           ...
           <?php require_once('inc\header.php'); ?>
            ...
            <div class="container-fluid body-section">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h1><i class="fa fa-user-plus"></i> Edit User <small> Edit Profile Details</small></h1><hr>
                        <ol class="breadcrumb">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label for="details" >Details:*</label>
                                         <textarea id="details" name="details" class="form-control" placeholder="Details" cols="30" rows="10"><?php echo $e_details; ?></textarea>
                                    </div>         
